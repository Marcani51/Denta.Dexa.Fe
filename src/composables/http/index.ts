import type { AxiosError, AxiosInstance, AxiosProxyConfig, AxiosRequestConfig } from 'axios'
import {
...
export type Config<TData = never, TError = any> = {
  keys?: any[]
  params?: Ref
...
export type HttpMutationOptions<TData = any, TError = any, TVariables = any, TContext = any> = {
